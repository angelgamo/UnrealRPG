...
void AUnrealRPGPlayerController::PlayerTick(float DeltaTime)
{
...
void AUnrealRPGPlayerController::OnSetDestinationPressed()
{
...
void AUnrealRPGPlayerController::OnSetDestinationReleased()
{
...
void AUnrealRPGPlayerController::OnTouchReleased(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	bIsTouch = false;
